...
! function (t, e, r, a, o) {
    ...
    "9Xmqu": [function (t, e, r) {
        t("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = {
    ...
    "2gKYH": [function (t, e, r) {
        ...
        class o {
            ...
            static get html() {
                return '<div class="art-video-player art-subtitle-show art-layer-show art-control-show art-mask-show"><video class="art-video"><track default kind="metadata" src=""></track></video><div class="art-poster"></div><div class="art-subtitle"></div><div class="art-danmuku"></div><div class="art-layers"></div><div class="art-mask"><div class="art-state"></div></div><div class="art-bottom"><div class="art-progress"></div><div class="art-controls"><div class="art-controls-left"></div><div class="art-controls-center"></div><div class="art-controls-right"></div></div></div><div class="art-loading"></div><div class="art-notice"><div class="art-notice-inner"></div></div><div class="art-settings"></div><div class="art-info"><img height="120" src="https://s1.imagehub.cc/images/2024/01/13/d0469ae970a9dac3b9e56aa223193e34.png"><div class="art-info-panel"><div class="art-info-item"><div class="art-info-title">Player version:</div><div class="art-info-content">MUSESTAR ArtPlayer v5.1.1</div></div><div class="art-info-item"><div class="art-info-title">Video url:</div><div class="art-info-content" data-video="src"></div></div><div class="art-info-item"><div class="art-info-title">Video volume:</div><div class="art-info-content" data-video="volume"></div></div><div class="art-info-item"><div class="art-info-title">Video time:</div><div class="art-info-content" data-video="currentTime"></div></div><div class="art-info-item"><div class="art-info-title">Video duration:</div><div class="art-info-content" data-video="duration"></div></div><div class="art-info-item"><div class="art-info-title">Video resolution:</div><div class="art-info-content"><span data-video="videoWidth"></span> x <span data-video="videoHeight"></span></div></div></div><div class="art-info-close">[x]</div></div><div class="art-contextmenus"></div></div>'
            }
            query(t) {
    ...
    "3ZSKq": [function (t, e, r) {
        ...
        const a = {
            "Video Info": "统计信息",
            Close: "关闭",
            "Video Load Failed": "加载失败，请尝试播放器右下角更换播放源或磁力下载观看，QQ交流群895700933",
            Volume: "音量",
            Play: "播放",
            Pause: "暂停",
            Rate: "速度",
            ...
            Horizontal: "水平",
            Vertical: "垂直",
            Reconnect: "重新连接中，可尝试更换播放器右下角更换播放源或磁力下载观看，QQ交流群895700933，重连次数",
            "Show Setting": "显示设置",
            "Hide Setting": "隐藏设置",
            Screenshot: "截图",
            "Play Speed": "播放速度",
        ...
        r.default = function (t) {
            ...
            (0, a.def)(t, "getDataURL", {
                value: () => new Promise(((t, a) => {
                    try {
                        o.width = r.videoWidth, o.height = r.videoHeight, o.getContext("2d").drawImage(r, 0, 0), t(o.toDataURL("image/png"))
                    } catch (t) {
                        e.show = t, a(t)
                    }
                }))
                ...
                value: () => new Promise(((t, a) => {
                    try {
                        o.width = r.videoWidth, o.height = r.videoHeight, o.getContext("2d").drawImage(r, 0, 0), o.toBlob((e => {
        ...
        class O extends i.default {
            ...
            init() {
                ...
                t.isLive || this.add((0, g.default)({
                    ...
                    position: "left",
                    index: 30
                })), t.quality.length && (0, o.sleep)().then((() => {
        ...
        r.default = class {
            ...
            addSelector(t, e, r) {
                ...
                const p = i(c, "click", (async e => {
                    const r = (e.composedPath() || []).find((t => (0, o.hasClass)(t, "art-selector-item")));
                    if (!r) return;
    ...
    f1W36: [function (t, e, r) {
        ...
        r.default = function (t) {
            return e => {
                ...
                } = e, n = o.map((t => `<span data-value="${t}">${1===t?r.get("Normal"):t.toFixed(1)}</span>`)).join("");
                return {
                    ...t,
                    ...
                    mounted: t => {
                        ...
                        r && (0, a.inverseClass)(r, "art-current"), e.on("video:ratechange", (() => {
                            const r = (0, a.queryAll)("span", t).find((t => Number(t.dataset.value) === e.playbackRate));
    ...
    afxZC: [function (t, e, r) {
        ...
        r.default = function (t) {
            return e => {
                ...
                } = e, n = o.map((t => `<span data-value="${t}">${"default"===t?r.get("Default"):t}</span>`)).join("");
                return {
                    ...t,
                    ...
                    mounted: t => {
                        ...
                        r && (0, a.inverseClass)(r, "art-current"), e.on("aspectRatio", (e => {
                            const r = (0, a.queryAll)("span", t).find((t => t.dataset.value === e));
                            r && (0, a.inverseClass)(r, "art-current")
                        }))
                    }
                }
    ...
    "9jCuX": [function (t, e, r) {
        ...
        r.default = function (t) {
            return e => {
                ...
                } = e, n = o.map((t => `<span data-value="${t}">${r.get((0,a.capitalize)(t))}</span>`)).join("");
                return {
                    ...t,
    ...
    k8wIZ: [function (t, e, r) {
        t("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = function (t) {
            return e => ({
                ...t,
    ...
    bb0TU: [function (t, e, r) {
        t("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = function (t) {
            return {
                ...t,
                html: '<a href="https://www.musestar.cc" target="_blank">MUSESTAR缪斯星</a>'
            }
        }
    }, {
        "@parcel/transformer-js/src/esmodule-helpers.js": "guZOB"
    ...
    lum0D: [function (t, e, r) {
        ...
        class p extends i.default {
            ...
            update() {
                ...
                t.innerHTML = "", this.activeCue && (this.art.option.subtitle.escape ? t.innerHTML = this.activeCue.text.split(/\r?\n/).map((t => `<div class="art-subtitle-line">${(0,o.escape)(t)}</div>`)).join("") : t.innerHTML = this.activeCue.text, this.art.emit("subtitleUpdate", this.activeCue.text))
            }
            async switch (t, e = {}) {
                const {
                    i18n: r,
            ...
            async init(t) {
                ...
                if ((0, l.default)(t, u.default.subtitle), t.url) return this.style(t.style), fetch(t.url).then((t => t.arrayBuffer())).then((e => {
                ...
                })).then((t => (r.innerHTML = "", this.url === t || (URL.revokeObjectURL(this.url), this.createTrack("metadata", t), this.art.emit("subtitleSwitch", t)), t))).catch((t => {
    ...
    ef6qz: [function (t, e, r) {
        t("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = function (t, e) {
            const {
                $player: r
            } = t.template;
            ...
            creatItem(t, e) {
                ...
                switch ((0, m.addClass)(u, "art-setting-item-right-tooltip"), (0, m.append)(u, e.tooltip || ""), (0, m.append)(s, u), e.$tooltip = u, (0, m.def)(e, "tooltip", {
                    ...
                    case "switch": {
                        ...
                        (0, m.setStyle)(e.switch ? o : a, "display", "none"), (0, m.append)(s, t), e.$switch = e.switch, (0, m.def)(e, "switch", {
                            configurable: !0,
                            get: () => e.$switch,
                            set(t) {
                    ...
                    case "range": {
                        const t = (0, m.createElement)("div");
                        (0, m.addClass)(t, "art-setting-item-right-icon");
                        const r = (0, m.append)(t, '<input type="range">');
                        r.value = e.range[0] || 0, r.min = e.range[1] || 0, r.max = e.range[2] || 10, r.step = e.range[3] || 1, (0, m.addClass)(r, "art-setting-range"), (0, m.append)(s, t), e.$range = r, (0, m.def)(e, "range", {
                            configurable: !0,
                            get: () => r.valueAsNumber,
                            set(t) {
                                r.value = Number(t)
                ...
                switch (t) {
                    ...
                    case "selector": {
                        ...
                        this.events.push(t), e.default && (0, m.addClass)(n, "art-current")
                    }
                }
                return n
            }
    ...
    bNOaj: [function (t, e, r) {
        ...
        r.default = function (t) {
            ...
            function i(t, r, o) {
                ...
                const n = (0, a.queryAll)(".art-setting-item", t).find((t => t.dataset.value === o));
    ...
    "5lAsp": [function (t, e, r) {
        ...
        r.default = function (t) {
            ...
            function s(t, e, r) {
                e && (e.innerText = i(r));
                const o = (0, a.queryAll)(".art-setting-item", t).find((t => t.dataset.value === r));
    ...
    e6hsR: [function (t, e, r) {
        ...
        r.default = function (t) {
            ...
            function s(t, e, r) {
                e && (e.innerText = i(r));
                const o = (0, a.queryAll)(".art-setting-item", t).find((t => Number(t.dataset.value) === r));
                o && (0, a.inverseClass)(o, "art-current")
            }
            return {
                width: o,
